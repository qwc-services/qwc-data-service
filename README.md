...
If you set `upload_user_field_suffix` in the data service config, the username of the last user who performed an upload to `<fieldname>` will be logged to `<fieldname>_<upload_user_field_suffix>`.
