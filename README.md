...
- *Note*: Make sure the client uses a recent version of the [EditInterface.js](https://github.com/qgis/qwc2-demo-app/blob/master/js/EditingInterface.js) to support file uploads.
